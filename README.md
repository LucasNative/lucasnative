...
<div style="display: flex; align-items: center; margin-botton:20px;"> <p style="font-size: 2rem;"><strong>Main languages:</strong></p>
...
<div style="display: flex; align-items: center;" > <p style="font-size: 2rem;"><strong>Technologies:</strong></p>&nbsp <a href="https://code.visualstudio.com/" target="_black"><img src="https://svgshare.com/i/UrB.svg" alt="vscode logo" height="43" width="43" style="margin-right: 2.4px;"/></a>&nbsp 
